...
-- Schema stadvdbmco1
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `stadvdbmco1` ;

-- -----------------------------------------------------
-- Schema stadvdbmco1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `stadvdbmco1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `stadvdbmco1` ;

-- -----------------------------------------------------
-- Table `stadvdbmco1`.`doctors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stadvdbmco1`.`doctors` (
...
-- -----------------------------------------------------
-- Table `stadvdbmco1`.`px`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stadvdbmco1`.`px` (
...
-- -----------------------------------------------------
-- Table `stadvdbmco1`.`clinics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stadvdbmco1`.`clinics` (
...
-- -----------------------------------------------------
-- Table `stadvdbmco1`.`appt_main`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stadvdbmco1`.`appt_main` (
  `pxid` VARCHAR(45) NOT NULL,
  `clinicid` VARCHAR(45) NOT NULL,
  `doctorid` VARCHAR(45) NOT NULL,
